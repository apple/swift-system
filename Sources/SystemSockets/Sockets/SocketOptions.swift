...
extension SocketDescriptor {
  ...
  public struct Option: RawRepresentable, Hashable, CustomStringConvertible {
    ...
    @_alwaysEmitIntoClient
    public static var debug: Option { Option(SO_DEBUG) }

    /// Enables local address reuse.
    ///
    /// The corresponding C constant is `SO_REUSEADDR`.
    @_alwaysEmitIntoClient
    public static var reuseAddress: Option { Option(SO_REUSEADDR) }

    /// Enables duplicate address and port bindings.
    ///
    /// The corresponding C constant is `SO_REUSEPORT`.
    @_alwaysEmitIntoClient
    public static var reusePort: Option { Option(SO_REUSEPORT) }

    /// Enables keep connections alive.
    ///
    /// The corresponding C constant is `SO_KEEPALIVE`.
    @_alwaysEmitIntoClient
    public static var keepAlive: Option { Option(SO_KEEPALIVE) }

    /// Enables routing bypass for outgoing messages.
    ///
    /// The corresponding C constant is `SO_DONTROUTE`.
    @_alwaysEmitIntoClient
    public static var doNotRoute: Option { Option(SO_DONTROUTE) }

    /// linger on close if data present
    ///
    /// The corresponding C constant is `SO_LINGER`.
    @_alwaysEmitIntoClient
    public static var linger: Option { Option(SO_LINGER) }

    /// Enables permission to transmit broadcast messages.
    ///
    /// The corresponding C constant is `SO_BROADCAST`.
    @_alwaysEmitIntoClient
    public static var broadcast: Option { Option(SO_BROADCAST) }

    /// Enables reception of out-of-band data in band.
    ///
    /// The corresponding C constant is `SO_OOBINLINE`.
    @_alwaysEmitIntoClient
    public static var outOfBand: Option { Option(SO_OOBINLINE) }

    /// Set buffer size for output.
    ///
    /// The corresponding C constant is `SO_SNDBUF`.
    @_alwaysEmitIntoClient
    public static var sendBufferSize: Option { Option(SO_SNDBUF) }

    /// Set buffer size for input.
    ///
    /// The corresponding C constant is `SO_RCVBUF`.
    @_alwaysEmitIntoClient
    public static var receiveBufferSize: Option { Option(SO_RCVBUF) }

    /// Set minimum count for output.
    ///
    /// The corresponding C constant is `SO_SNDLOWAT`.
    @_alwaysEmitIntoClient
    public static var sendLowWaterMark: Option { Option(SO_SNDLOWAT) }

    /// Set minimum count for input.
    ///
    /// The corresponding C constant is `SO_RCVLOWAT`.
    @_alwaysEmitIntoClient
    public static var receiveLowWaterMark: Option { Option(SO_RCVLOWAT) }

    /// Set timeout value for output.
    ///
    /// The corresponding C constant is `SO_SNDTIMEO`.
    @_alwaysEmitIntoClient
    public static var sendTimeout: Option { Option(SO_SNDTIMEO) }

    /// Set timeout value for input.
    ///
    /// The corresponding C constant is `SO_RCVTIMEO`.
    @_alwaysEmitIntoClient
    public static var receiveTimeout: Option { Option(SO_RCVTIMEO) }

    /// Get the type of the socket (get only).
    ///
    /// The corresponding C constant is `SO_TYPE`.
    @_alwaysEmitIntoClient
    public static var getType: Option { Option(SO_TYPE) }

    /// Get and clear error on the socket (get only).
    ///
    /// The corresponding C constant is `SO_ERROR`.
    @_alwaysEmitIntoClient
    public static var getError: Option { Option(SO_ERROR) }
    ...
    @_alwaysEmitIntoClient
    public static var noSignal: Option { Option(SO_NOSIGPIPE) }
    ...
    @_alwaysEmitIntoClient
    public static var tcpConnectionTimeout: Option { Option(TCP_CONNECTIONTIMEOUT) }
    ...
    @_alwaysEmitIntoClient
    public static var tcpKeepAliveInterval: Option { Option(TCP_KEEPINTVL) }
    ...
    @_alwaysEmitIntoClient
    public static var tcpKeepAliveCount: Option { Option(TCP_KEEPCNT) }
    ...
    @_alwaysEmitIntoClient
    public static var tcpSendMoreAcks: Option { Option(TCP_SENDMOREACKS) }

    /// Use Explicit Congestion Notification (ECN).
    ///
    /// The corresponding C constant is `TCP_ENABLE_ECN`.
    @_alwaysEmitIntoClient
    public static var tcpUseExplicitCongestionNotification: Option { Option(TCP_ENABLE_ECN) }

    /// Specify the maximum amount of unsent data in the send socket buffer.
    ///
    /// The corresponding C constant is `TCP_NOTSENT_LOWAT`.
    @_alwaysEmitIntoClient
    public static var tcpMaxUnsent: Option { Option(TCP_NOTSENT_LOWAT) }
    ...
    @_alwaysEmitIntoClient
    public static var tcpFastOpen: Option { Option(TCP_FASTOPEN) }

    /// Optain TCP connection-level statistics.
    ///
    /// The corresponding C constant is `TCP_CONNECTION_INFO`.
    @_alwaysEmitIntoClient
    public static var tcpConnectionInfo: Option { Option(TCP_CONNECTION_INFO) }
    ...
    @_alwaysEmitIntoClient
    public static var ipOptions: Option { Option(IP_OPTIONS) }

    /// Set the type-of-service.
    ///
    /// The corresponding C constant is `IP_TOS`.
    @_alwaysEmitIntoClient
    public static var ipTypeOfService: Option { Option(IP_TOS) }

    /// Set the time-to-live.
    ///
    /// The corresponding C constant is `IP_TTL`.
    @_alwaysEmitIntoClient
    public static var ipTimeToLive: Option { Option(IP_TTL) }
    ...
    @_alwaysEmitIntoClient
    public static var ipHeaderIncluded: Option { Option(IP_HDRINCL) }
    ...
    @_alwaysEmitIntoClient
    public static var ipv6UnicastHops: Option { Option(IPV6_UNICAST_HOPS) }
    ...
    @_alwaysEmitIntoClient
    public static var ipv6MulticastInterface: Option { Option(IPV6_MULTICAST_IF) }

    /// The default hop limit header field for outgoing multicast datagrams.
    ///
    /// The corresponding C constant is `IPV6_MULTICAST_HOPS`.
    @_alwaysEmitIntoClient
    public static var ipv6MulticastHops: Option { Option(IPV6_MULTICAST_HOPS) }

    /// Whether multicast datagrams will be looped back.
    ///
    /// The corresponding C constant is `IPV6_MULTICAST_LOOP`.
    @_alwaysEmitIntoClient
    public static var ipv6MulticastLoop: Option { Option(IPV6_MULTICAST_LOOP) }

    /// Join a multicast group.
    ///
    /// The corresponding C constant is `IPV6_JOIN_GROUP`.
    @_alwaysEmitIntoClient
    public static var ipv6JoinGroup: Option { Option(IPV6_JOIN_GROUP) }

    /// Leave a multicast group.
    ///
    /// The corresponding C constant is `IPV6_LEAVE_GROUP`.
    @_alwaysEmitIntoClient
    public static var ipv6LeaveGroup: Option { Option(IPV6_LEAVE_GROUP) }
    ...
    @_alwaysEmitIntoClient
    public static var ipv6PortRange: Option { Option(IPV6_PORTRANGE) }
...
//    @_alwaysEmitIntoClient
//    public static var ipv6ReceivePacketInfo: Option { Option(IPV6_PKTINFO) }
//
...
//    @_alwaysEmitIntoClient
//    public static var ipv6ReceiveHopLimit: Option { Option(IPV6_HOPLIMIT) }
//
...
//    @_alwaysEmitIntoClient
//    public static var ipv6ReceiveHopOptions: Option { Option(IPV6_HOPOPTS) }
//
...
//    @_alwaysEmitIntoClient
//    public static var ipv6ReceiveDestinationOptions: Option { Option(IPV6_DSTOPTS) }

    /// The value of the traffic class field for outgoing datagrams.
    ///
    /// The corresponding C constant is `IPV6_TCLASS`.
    @_alwaysEmitIntoClient
    public static var ipv6TrafficClass: Option { Option(IPV6_TCLASS) }
    ...
    @_alwaysEmitIntoClient
    public static var ipv6ReceiveTrafficClass: Option { Option(IPV6_RECVTCLASS) }
...
//    @_alwaysEmitIntoClient
//    public static var ipv6ReceiveRoutingHeader: Option { Option(IPV6_RTHDR) }
//
